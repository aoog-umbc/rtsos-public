...
!IF((idtau==1 .and. iphi==3))THEN
!  write(*,'(6(2x,E12.6))')acos(MUOUTSHFLA(ITHETA))/pi*180.0d0,PHIOUT(IPHI),&
!		  LRADA_SNG(ITHETA,INDXDETA_SNGSCAT(IDTAU),IPHI)%VRAD(1),&
...
ENDIF   !EXACT SPHERICAL SHELL CORRECTION and VIEWING ZENITH ANGLE > CRITICAL ANGLE
