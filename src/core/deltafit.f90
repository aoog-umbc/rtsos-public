SUBROUTINE DELTAFIT
USE RTUTILITY, ONLY : PI,MAXLORD,RAMAN_SOURCE_FLAG
...
DOUBLE PRECISION,  DIMENSION(:),ALLOCATABLE :: ANG,P11FIT,P11,P12,P22,P33,P34,P44
...
OUTPUTTST=.false.     ! IF TRUE, WRITE INPUT AND OUTPUT FILE FOR COMPARISON
...
INTEGER, INTENT(IN) ::NUMLORD
DOUBLE PRECISION,INTENT(IN),DIMENSION(0:*)::BETAL,ALPHAL,ZETAL,DELTAL,GAMMAL,EPSILONL
DOUBLE PRECISION,ALLOCATABLE,DIMENSION(:)::DL00,DL20,DL2P2,DL2N2

DOUBLE PRECISION ::P11,P12,P22,P33,P34,P44
INTEGER :: IANG,L,NUMANG
DOUBLE PRECISION :: PI,ANG,DANG,MU
...
INTEGER :: NUMANG,IANG
DOUBLE PRECISION,DIMENSION(NUMANG)::ANG
