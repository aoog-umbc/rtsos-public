...
DOUBLE PRECISION :: SPHI,FPHI,SA,SB,SC,FA,FB,FC
DOUBLE PRECISION,DIMENSION(4,4) :: TEM1,TEM2,SLI1,SLI2
...
! The Netherlands, SRON-SPEXoneL1-2020-02, issue: 0.90, 2020
    ...
    FRES_MTRX=Bpol*EXP(-tan(THETA1))*EXP(-vfac)*TEM1/(4.0d0*(abs(COST1)+abs(COST2)))
    FRES_MTRX=FRES_MTRX*abs(COST1)

	FRES_MTRX(3,1)=-FRES_MTRX(3,1)
	FRES_MTRX(3,2)=-FRES_MTRX(3,2)
	FRES_MTRX(4,1)=-FRES_MTRX(4,1)
	FRES_MTRX(4,2)=-FRES_MTRX(4,2)
