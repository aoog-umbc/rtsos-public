      SUBROUTINE REFWAT1(IUNIT,XLAM,TEMP,RN,CN,ABSIND,ABSCOF)
c
...
C       pflatau@ucsd.edu
C 
C Method and references:
C
C (1)   See method and references in REFWAT
C (2)   Complex part of refractive index between 380-727.5nm from:
C       Pope, R.M.; Fry, E.S. Absorption spectrum (380-700 nm) of pure water. 
C       II. Integrating cavity measurements.
C       Applied Optics, 20 Nov. 1997, vol.36, (no.33):8710-23.
C 
C     INPUT PARAMETERS
C     
C     IUNIT = -1 FOR WAVELENGTH SPECIFIED IN NANOMETERS
...
C     XLAM = WAVELENGTH ( NONOMETERS, MICRONS OR MM OR CM OR CM**-1 )
C     TEMP = TEMPERATURE ( DEGREES KELVIN )
C
C     OUTPUT PARAMETERS
C     
...
C     ABSCOF = ABORPTION COEFFICIENT ( 4*PI*CN/XLAM ) [1/m]
C     
C     local variables:
C     wavenano             : wavelength in nanometers
C     fact                 : used for logarithmic interpolation
C     wavepope97(1:mxpope) : wavelengths
C     abspope97(1:mxpope)  : absorption [1/m] (Pope97 doesn't provide
C                            real refractive index (or, in that matter
C                            complex refractive index)
C     wl                   : wavelenght converted to microns                       
      integer mxpope, j, iunit
      real pi, xlam, temp, rn, cn, absind, abscof, wl, wavenano, fact
      parameter (mxpope=140)
...
C convert absorption index to refractive index
      ...
      ABSIND=0.0
      ABSCOF=0.0
C convert it to microns
      WL=XLAM
      IF(IUNIT.EQ.-1)WL=WL/1000.
      IF(IUNIT.EQ.1)WL=1000*WL
      IF(IUNIT.EQ.2)WL=10000*WL
      IF(IUNIT.EQ.3)WL=10000*(1.0/WL)
      cxref=refwat(wl,temp)
      rn=real(cxref)
      cn=aimag(cxref)
      absind=cn/rn
      abscof=4.*pi*cn/(wl*1.e-6)
C Correct  Segelstein, D., 1981 complex part with Pope, R.M.; Fry, E.S., 1997
      wavenano=wl*1000.
...
c ---------------------------------------------------------------------
c History:
C 98.07.16 (PJF): modified to add Pope97 tables wavepope97, abspope97
c     .. Parameters ..
...
c                 University of Missouri--Kansas City
c
C Complex part of refractive index between 380-700nm
C Pope, R.M.; Fry, E.S.
C Absorption spectrum (380-700 nm) of pure water. II. Integrating cavity
C measurements.
C Applied Optics, 20 Nov. 1997, vol.36, (no.33):8710-23.
...
c     ..
       data wavepope97/
     $ 380.0000, 382.5000, 385.0000, 387.5000, 390.0000, 
     $ 392.5000, 395.0000, 397.5000, 400.0000, 402.5000, 405.0000, 
     $ 407.5000, 410.0000, 412.5000, 415.0000, 417.5000, 420.0000, 
     $ 422.5000, 425.0000, 427.5000, 430.0000, 432.5000, 435.0000, 
     $ 437.5000, 440.0000, 442.5000, 445.0000, 447.5000, 450.0000, 
     $ 452.5000, 455.0000, 457.5000, 460.0000, 462.5000, 465.0000, 
     $ 467.5000, 470.0000, 472.5000, 475.0000, 477.5000, 480.0000, 
     $ 482.5000, 485.0000, 487.5000, 490.0000, 492.5000, 495.0000, 
     $ 497.5000, 500.0000, 502.5000, 505.0000, 507.5000, 510.0000, 
     $ 512.5000, 515.0000, 517.5000, 520.0000, 522.5000, 525.0000, 
     $ 527.5000, 530.0000, 532.5000, 535.0000, 537.5000, 540.0000, 
     $ 542.5000, 545.0000, 547.5000, 550.0000, 552.5000, 555.0000, 
     $ 557.5000, 560.0000, 562.5000, 565.0000, 567.5000, 570.0000, 
     $ 572.5000, 575.0000, 577.5000, 580.0000, 582.5000, 585.0000, 
     $ 587.5000, 590.0000, 592.5000, 595.0000, 597.5000, 600.0000, 
     $ 602.5000, 605.0000, 607.5000, 610.0000, 612.5000, 615.0000, 
     $ 617.5000, 620.0000, 622.5000, 625.0000, 627.5000, 630.0000, 
     $ 632.5000, 635.0000, 637.5000, 640.0000, 642.5000, 645.0000, 
     $ 647.5000, 650.0000, 652.5000, 655.0000, 657.5000, 660.0000, 
     $ 662.5000, 665.0000, 667.5000, 670.0000, 672.5000, 675.0000, 
     $ 677.5000, 680.0000, 682.5000, 685.0000, 687.5000, 690.0000, 
     $ 692.5000, 695.0000, 697.5000, 700.0000, 702.5000, 705.0000, 
     $ 707.5000, 710.0000, 712.5000, 715.0000, 717.5000, 720.0000, 
     $ 722.5000, 725.0000, 727.5000/
      data abspope97/
     $ 1.1370000E-02, 1.0440000E-02, 9.4100004E-03, 9.1700004E-03, 
     $ 8.5100001E-03, 8.2900003E-03, 8.1300000E-03, 7.7499999E-03, 
     $ 6.6300002E-03, 5.7899999E-03, 5.2999998E-03, 5.0300001E-03, 
     $ 4.7300002E-03, 4.5200000E-03, 4.4399998E-03, 4.4200001E-03, 
     $ 4.5400001E-03, 4.7399998E-03, 4.7800001E-03, 4.8199999E-03, 
     $ 4.9500000E-03, 5.0400002E-03, 5.2999998E-03, 5.7999999E-03, 
     $ 6.3499999E-03, 6.9599999E-03, 7.5099999E-03, 8.2999999E-03, 
     $ 9.2200004E-03, 9.6899997E-03, 9.6199997E-03, 9.5699998E-03, 
     $ 9.7899996E-03, 1.0050000E-02, 1.0110000E-02, 1.0200000E-02, 
     $ 1.0600000E-02, 1.0900000E-02, 1.1400000E-02, 1.2100000E-02, 
     $ 1.2700000E-02, 1.3100000E-02, 1.3600000E-02, 1.4400000E-02, 
     $ 1.5000000E-02, 1.6200000E-02, 1.7300000E-02, 1.9099999E-02, 
     $ 2.0400001E-02, 2.2800000E-02, 2.5599999E-02, 2.8000001E-02, 
     $ 3.2499999E-02, 3.7200000E-02, 3.9600000E-02, 3.9900001E-02, 
     $ 4.0899999E-02, 4.1600000E-02, 4.1700002E-02, 4.2800002E-02, 
     $ 4.3400001E-02, 4.4700000E-02, 4.5200001E-02, 4.6599999E-02, 
     $ 4.7400001E-02, 4.8900001E-02, 5.1100001E-02, 5.3700000E-02, 
     $ 5.6499999E-02, 5.9300002E-02, 5.9599999E-02, 6.0600001E-02, 
     $ 6.1900001E-02, 6.4000003E-02, 6.4199999E-02, 6.7199998E-02, 
     $ 6.9499999E-02, 7.3299997E-02, 7.7200003E-02, 8.3600000E-02, 
     $ 8.9599997E-02, 9.8899998E-02, 0.1100000, 0.1220000, 
     $ 0.1351000, 0.1516000, 0.1672000, 0.1925000, 0.2224000, 
     $ 0.2470000, 0.2577000, 0.2629000, 0.2644000, 0.2665000, 
     $ 0.2678000, 0.2707000, 0.2755000, 0.2810000, 0.2834000, 
     $ 0.2904000, 0.2916000, 0.2995000, 0.3012000, 0.3077000, 
     $ 0.3108000, 0.3220000, 0.3250000, 0.3350000, 0.3400000, 
     $ 0.3580000, 0.3710000, 0.3930000, 0.4100000, 0.4240000, 
     $ 0.4290000, 0.4360000, 0.4390000, 0.4480000, 0.4480000, 
     $ 0.4610000, 0.4650000, 0.4780000, 0.4860000, 0.5020000, 
     $ 0.5160000, 0.5380000, 0.5590000, 0.5920000, 0.6240000, 
     $ 0.6630000, 0.7040000, 0.7560000, 0.8270000, 0.9140000, 
     $ 1.007000, 1.119000, 1.231000, 1.356000, 1.489000, 1.678000/
      END
