...
REAL*8,DIMENSION(NWave_SnowBRDF_nm) :: Wave_SnowBRDF_nm,SNOW_ALBEDO
REAL*8,DIMENSION(NThetaV_ABCD) :: ThetaV_ABCD
REAL*8,DIMENSION(NThetaV_E) :: ThetaV_E
REAL*8,DIMENSION(NThetaV_F) :: ThetaV_F
REAL*8,DIMENSION(NPhiV_Snow) :: PhiV_Snow

REAL*8,DIMENSION(NThetaV_GRID) :: ThetaV_GRID
REAL*8,DIMENSION(NPhiV_GRID) :: PhiV_GRID
REAL*8,DIMENSION(NThetaV_GRID,NPhiV_GRID) :: SnowBRDF_GRID

REAL*8,DIMENSION(NThetaV_ABCD,NPhiV_Snow) :: EOF1_A,EOF2_A,EOF1_B,EOF2_B,&
            EOF1_C,EOF2_C,EOF1_D,EOF2_D,EOF3_D
REAL*8,DIMENSION(NThetaV_E,NPhiV_Snow) :: EOF1_E
REAL*8,DIMENSION(NThetaV_F,NPhiV_Snow) :: EOF1_F,EOF2_F
...
REAL*8, INTENT(IN) :: MU0,LAMBDA_NM
CHARACTER,INTENT(IN) :: CASESTRING
REAL*8,DIMENSION(3),INTENT(OUT) ::V_VAL,EIGEN_VAL
REAL*8,INTENT(in) ::ALBEDO_LOCAL

REAL*8 :: ABSMU0,MU_M_WV,LAMBDA_MICRON,MU_M_ALBEDO
...
REAL*8, INTENT(IN) :: MU0,LAMBDA_NM
REAL*8,DIMENSION(3) ::V_VAL,EIGEN_VAL
REAL*8,INTENT(OUT) :: ALBEDO_LOCAL

REAL*8, EXTERNAL :: POLINT_SIMPLE

REAL*8 :: ABSMU0,THETA0,LAMBDA_NM_LOCAL
...
ALBEDO_LOCAL =POLINT_SIMPLE(NWave_SnowBRDF_nm,Wave_SnowBRDF_nm,SNOW_ALBEDO,LAMBDA_NM,3)
...
IMPLICIT none
REAL*8,INTENT(IN) :: WAVELENGTH_MICRON,COST1,PHI1,COST2,PHI2,GLBDO
REAL*8,DIMENSION(4,4),INTENT(OUT) :: BRDML

REAL*8 :: LAMBDA_NM,SINT1,SINT2,THETA1,THETA2, PHIV ,RTMP,ALBEDO_LOCAL,dy
!write(*,*)'WAVELENGTH_MICRON=',WAVELENGTH_MICRON
INTEGER :: ITEMP,ITEMP1
LOGICAL :: USER_GLBDO_INPUT=.FALSE.
...
call polin2(ThetaV_GRID,PhiV_GRID,SnowBRDF_GRID,NThetaV_GRID,NPhiV_GRID,THETA2,PHIV,RTMP,dy)
