...
REAL*8,DIMENSION(:,:),ALLOCATABLE :: FULLBETAL,FULLALPHAL,FULLZETAL,FULLDELTAL, &
					FULLGAMMAL,FULLEPSILONL
...
ALLOCATE(NUMMIEANG(NUMMIE),THETA_SNG(NUMMIE,MAXMIEANG_LOCAL), &
		 ...
		 FULLBETAL(NUMMIE,0:MAXLFULL),FULLALPHAL(NUMMIE,0:MAXLFULL),&
		 FULLZETAL(NUMMIE,0:MAXLFULL),FULLDELTAL(NUMMIE,0:MAXLFULL),&
		 FULLGAMMAL(NUMMIE,0:MAXLFULL),FULLEPSILONL(NUMMIE,0:MAXLFULL))
...
DEALLOCATE(NUMMIEANG,THETA_SNG,MU_SNG,PM_AO_SNG,PHF_RESIDUE,NUMORDFULLBETAL ,&
		 FULLBETAL,FULLALPHAL,FULLZETAL,FULLDELTAL,FULLGAMMAL,FULLEPSILONL)
