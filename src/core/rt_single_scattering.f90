...
DOUBLE PRECISION,DIMENSION(NDET,2) :: DIRAD  ! DIRAD(:,1) DOWNWELLING IRADIANCE
                                   ! DIRAD(:,2) UPWELLING IRADIANCE
DOUBLE PRECISION,DIMENSION(NDET,NTHETAOUT,NPHIOUT,4) :: DSTOKES
...
DOUBLE PRECISION,DIMENSION(:,:),ALLOCATABLE :: RADATMP1,RADOTMP,RADOTMP1,RADOUTTMP
DOUBLE PRECISION,DIMENSION(:,:),ALLOCATABLE :: RADDETU
...
ALLOCATE(NUMMIEANG(NUMMIE),THETA_SNG(NUMMIE,NUMMIEANGMAX), &
         ...
         PHF_RESIDUE(NUMMIE,NUMMIEANGMAX),NUMORDFULLBETAL(NUMMIE),&
...
DEALLOCATE(NUMMIEANG,THETA_SNG,MU_SNG,PM_AO_SNG,PHF_RESIDUE,NUMORDFULLBETAL,FULLBETAL)
...
DOUBLE PRECISION,DIMENSION(4)   :: ARRY1,ARRY2,ARRY3,ARRY4
DOUBLE PRECISION,DIMENSION(4,4) :: MTRX1,MTRX2
...
DOUBLE PRECISION :: ANGCUT,MUF,RTMP,COEFF1,COEFF2,COEFF3

! DELTA FIT DIFINITION
DOUBLE PRECISION,  DIMENSION(:),ALLOCATABLE :: ANG,P11FIT
DOUBLE PRECISION,DIMENSION(:),ALLOCATABLE :: BETAL_LOCAL

DOUBLE PRECISION :: FTRUNCFIT
