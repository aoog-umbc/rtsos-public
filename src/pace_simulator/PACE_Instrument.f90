...
!
!DOUBLE PRECISION,PARAMETER :: WV_START=340D0 !,WV_END=1000.D0
INTEGER :: NWV_BAND
DOUBLE PRECISION,DIMENSION(:),ALLOCATABLE :: WV_BAND,PACE_FWHM

DOUBLE PRECISION,PARAMETER :: OCI_SEG1_RESO_HYPO=5.0D0
!DOUBLE PRECISION,DIMENSION(NWV_BAND_HYPO):: WV_BAND_HYPO,PACE_FWHM_HYPO=0.0d0
...
DOUBLE PRECISION,DIMENSION(:),ALLOCATABLE :: WV_BAND_HYPO,PACE_FWHM_HYPO

INTEGER,PARAMETER :: NILS_PACE_RAW=20926,NILS_SPEXone=2001,NILS_HARP=163,NILS_HARP2_HEADER=18
DOUBLE PRECISION,DIMENSION(:),ALLOCATABLE :: ILS_WaveLength
DOUBLE PRECISION,DIMENSION(:,:),ALLOCATABLE :: ILS_DeltaWaveLength_RAW,ILS_PACE_RAW

INTEGER,DIMENSION(:),ALLOCATABLE :: NILS_PACE
DOUBLE PRECISION,DIMENSION(:,:),ALLOCATABLE :: ILS_DeltaWaveLength,ILS_PACE
DOUBLE PRECISION,DIMENSION(25) :: RARR_TMP
...
DOUBLE PRECISION Delta_Wavelength_Max,Delta_Wavelength_Sub,Factor,RTMP
...
REAL,DIMENSION(:),TARGET,ALLOCATABLE :: HDF5RARRD1
REAL,DIMENSION(:,:),TARGET,ALLOCATABLE :: HDF5RARR2DIM
REAL,DIMENSION(:,:,:),TARGET,ALLOCATABLE :: HDF5RARR3DIM

DOUBLE PRECISION,DIMENSION(:),TARGET,ALLOCATABLE :: HDF5RARR_DB1
DOUBLE PRECISION,DIMENSION(:,:),TARGET,ALLOCATABLE :: HDF5RARR_DB2DIM
...
ALLOCATE(WV_BAND(NWV_BAND),PACE_FWHM(NWV_BAND),NILS_PACE(NWV_BAND))
PACE_FWHM=0.0D0
...
DO IWV=1,NWV_BAND_SEG1P2
	...
	DO ILS_LINE=1,NILS_PACE_RAW
       IF(ILS_PACE_RAW(IWV,ILS_LINE)>=1.0e-4)THEN
            NILS_MIN=ILS_LINE
            EXIT
		ENDIF
	ENDDO

	DO ILS_LINE=NILS_PACE_RAW,1,-1
	   IF(ILS_PACE_RAW(IWV,ILS_LINE)>=1.0e-4)THEN
			NILS_MAX=ILS_LINE
			EXIT
		ENDIF
	ENDDO
	NILS_PACE(IWV)=NILS_MAX-NILS_MIN+1
ENDDO
NILS_MAX=maxval(NILS_PACE)
WRITE(*,*)'NILS_PACE_RAW,NILS_MAX=',NILS_PACE_RAW,NILS_MAX

ALLOCATE(ILS_DeltaWaveLength(NWV_BAND,NILS_MAX),ILS_PACE(NWV_BAND,NILS_MAX))
ILS_DeltaWaveLength=0.0d0
ILS_PACE=0.0d0
DO IWV=1,NWV_BAND_SEG1P2
	ILS_LINE_TEMP=0
	DO ILS_LINE=1,NILS_PACE_RAW
	   IF(ILS_PACE_RAW(IWV,ILS_LINE)<1.0e-4) CYCLE
       ILS_DeltaWaveLength(IWV,1:NILS_PACE(IWV)) = &
                 ILS_DeltaWaveLength_RAW(IWV,ILS_LINE:NILS_PACE(IWV)+ILS_LINE-1)
	   ILS_PACE(IWV,1:NILS_PACE(IWV))= &
                 ILS_PACE_RAW(IWV,ILS_LINE:NILS_PACE(IWV)+ILS_LINE-1)
       EXIT
	ENDDO
ENDDO
...
SUBROUTINE PACE_FWHM_DEALLO
   ...
   DEALLOCATE(WV_BAND,PACE_FWHM,NILS_PACE)
