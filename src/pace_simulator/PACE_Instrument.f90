...
USE HDF5
INTEGER,PARAMETER :: NWV_BAND=236,NWV_BAND_SEG1=116, NWV_BAND_SEG2=7,&
                     NWV_BAND_SEG1P2=123,NWV_BAND_SEG3=109,NWV_BAND_SEG4=4
! NWV_BAND_SEG1: OCI UV+Visible+NIR
! NWV_BAND_SEG2: OCI SWIR
! NWV_BAND_SEG3: SPEXone
! NWV_BAND_SEG4: HARP-2
!
!REAL*8,PARAMETER :: WV_START=340D0 !,WV_END=1000.D0

REAL*8,DIMENSION(NWV_BAND):: WV_BAND,PACE_FWHM=0.0d0

INTEGER,PARAMETER :: NILS_PACE=2120
REAL*8,DIMENSION(NILS_PACE) :: ILS_WaveLength
...
IF(NWV_BAND /= NWV_BAND_SEG1+NWV_BAND_SEG2+NWV_BAND_SEG3+NWV_BAND_SEG4) STOP 'CHECK NWV_BAND'
IF(NWV_BAND_SEG1P2 /= NWV_BAND_SEG1+NWV_BAND_SEG2) STOP 'CHECK NWV_BAND_SEG1P2'

OCI_ILS_Filename=trim(aux_dir)//'OCI_RSR_v0_convert2.h5'

CALL h5open_f(hdferr)
CALL h5fopen_f(OCI_ILS_Filename, H5F_ACC_RDONLY_F, file, hdferr)

ALLOCATE(HDF5RARRD1(NILS_PACE))
...
ALLOCATE(HDF5RARR2DIM(NWV_BAND_SEG1P2,NILS_PACE))
...
CALL h5dclose_f(dset , hdferr)
CALL h5sclose_f(space, hdferr)
ILS_PACE(1:NWV_BAND_SEG1P2,1:NILS_PACE)=HDF5RARR2DIM(1:NWV_BAND_SEG1P2,1:NILS_PACE)
DEALLOCATE(HDF5RARR2DIM)

!WRITE(*,*)'TESTING, ILS_PACE(1,16),ILS_PACE(1,31),ILS_PACE(1,48)=', &
!  ILS_PACE(1,16),ILS_PACE(1,31),ILS_PACE(1,48)
!WRITE(*,*)'TESTING, ILS_PACE(123,2065)=',ILS_PACE(123,2065)
...
DO ILS_LINE=1,NILS_PACE
   ILS_DeltaWaveLength(IWV,ILS_LINE)=ILS_WaveLength(ILS_LINE)-WV_BAND(IWV)
ENDDO
ENDDO
...
PACE_FWHM(NWV_BAND_SEG1P2+NWV_BAND_SEG3+1)=15.0d0
PACE_FWHM(NWV_BAND_SEG1P2+NWV_BAND_SEG3+2)=12.0d0
PACE_FWHM(NWV_BAND_SEG1P2+NWV_BAND_SEG3+3)=16.0d0
PACE_FWHM(NWV_BAND_SEG1P2+NWV_BAND_SEG3+4)=43.0d0

WV_BAND(NWV_BAND_SEG1P2+NWV_BAND_SEG3+1:NWV_BAND)= &
                         (/441d0,549d0, 669d0,873d0/)
