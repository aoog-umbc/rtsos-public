...
!            DIRADTMP(1:NDET,IWV_CAL,1:2)=DIRADTMP(1:NDET,IWV_CAL,1:2)-DIRAD(1:NDET,1:2)*RTMP1
  ...
  ENDDO
  WAVELENGTH_Table_Save(IWV_BAND-NWV_BAND_START+1)=WV(INDX_WV_CAL(1))
  TAU_ARSL_Ext_Save(IWV_BAND-NWV_BAND_START+1,:)=TAU_ARSL_Ext_TMP(1,:)
  TAU_ARSL_Scat_Save(IWV_BAND-NWV_BAND_START+1,:)=TAU_ARSL_Scat_TMP(1,:)
  TAU_RAY_Save(IWV_BAND-NWV_BAND_START+1,:)=TAU_RAY_TMP(1,:)
  DEPOL_A_Save(IWV_BAND-NWV_BAND_START+1,:)=DEPOL_A_TMP(1,:)
  IF(MONOCHROMATIC_FLAG)THEN
