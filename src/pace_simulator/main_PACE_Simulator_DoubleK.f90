...
ALLOCATE(TAU_ARSL_Ext_Save(NWV_BAND_SEG1P2_HYPO,NTLYERA),TAU_ARSL_Scat_Save(NWV_BAND_SEG1P2_HYPO,NTLYERA), &
         TAU_RAY_Save(NWV_BAND_SEG1P2_HYPO,NTLYERA),DEPOL_A_Save(NWV_BAND_SEG1P2_HYPO,NTLYERA))
...
DEALLOCATE(DIRAD,DSTOKES,DIRADFULL,DSTOKESFULL,                                &
          ...
          TAU_ARSL_Ext_Save,TAU_ARSL_Scat_Save,TAU_RAY_Save,DEPOL_A_Save,      &
          TAU_TG_Save,TAU_TG_H2O_Save,TAU_TG_CO2_Save,TAU_TG_CH4_Save,         &
          TAU_TG_O2_Save,TAU_TG_O3_Save,TAU_TG_NO2_Save)
  ...
  DO IWV_AVG=NWV_START,NWV_END
     ...
     DO ILAYER=1,NTLYERA
		...
		IF(WV_BAND(IWV_AVG)<900.0d0)THEN
			...
			TAU_ARSL_Ext_AVG(IWV_AVG,ILAYER)=POLINT_SIMPLE(NWV_BAND_SEG1P2_HYPO,WV_BAND_HYPO,TempU,WV_BAND(IWV_AVG),3)
			TempU=TAU_ARSL_Scat_Save(:,ILAYER)
			TAU_ARSL_Scat_AVG(IWV_AVG,ILAYER)=POLINT_SIMPLE(NWV_BAND_SEG1P2_HYPO,WV_BAND_HYPO,TempU,WV_BAND(IWV_AVG),3)
			TempU=TAU_RAY_Save(:,ILAYER)
			TAU_RAY_AVG(IWV_AVG,ILAYER)=POLINT_SIMPLE(NWV_BAND_SEG1P2_HYPO,WV_BAND_HYPO,TempU,WV_BAND(IWV_AVG),4)
			TempU=DEPOL_A_Save(:,ILAYER)
			DEPOL_A_AVG(IWV_AVG,ILAYER)=POLINT_SIMPLE(NWV_BAND_SEG1P2_HYPO,WV_BAND_HYPO,TempU,WV_BAND(IWV_AVG),3)
		ELSE
			LOCINDXTMP2=MINLOC(ABS(WV_BAND(IWV_AVG)-WV_BAND_HYPO))
