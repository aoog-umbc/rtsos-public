...
!IF(WV_SEG_FLAG==4) MONOCHROMATIC_FLAG=1
...
DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
  ...
  LOCINDXTMP= MINLOC(ABS(WV_BAND(IWV_BAND)-RTMP*PACE_FWHM(IWV_BAND)-WV))
  LOCINDXTMP1=MINLOC(ABS(WV_BAND(IWV_BAND)+RTMP*PACE_FWHM(IWV_BAND)-WV))
