...
DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
  ...
  ENDIF
  WRITE(*,*)'IWV_BAND,WV_BAND,WV_SUB_START,WV_SUB_END=', &
               IWV_BAND,WV_BAND_HYPO(IWV_BAND),WV(IWV_SUB_START),WV(IWV_SUB_END)
...
DOUBLE PRECISION,DIMENSION(NILS_PACE) :: XK,YK
