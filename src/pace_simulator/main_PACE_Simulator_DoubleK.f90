		 ...
		 DO IWV_SUB=IWV_SUB_START,IWV_SUB_END
			...
			IF(SNG_SCAT_EXACT)THEN
			  ...
			  CALL RTSOSINIT(Indx_Inelastic_Scattering,IWV_SUB,WAVELENGTH_MICRON,&
				...
				PHMXDATASTREAM,LBDO_LD,FLAM,CHLa,TEMPERTURE,SALINITY,            &
...
SUBROUTINE RTSOSINIT(Indx_Inelastic_Scattering,IWVSAVE,WAVELENGTH_MICRON,NREC,  &
       ...
       TAU_ARSL_Scat_TMP,RECDATASTREAM,NTLYER,&
       NUMMIERT,MAXLORDINPUT,NUMMIEANGINPUT,PHMXDATASTREAM,LBDO_LD,FLAM,CHLa,   &
       TEMPERTURE,SALINITY,pBRDFa_input,pBRDFk_input,pBRDFb_input,pBRDFe_input)
...
INTEGER,INTENT(IN) :: Indx_Inelastic_Scattering,IWVSAVE,NREC,NTLYER,&
                      NUMMIERT,MAXLORDINPUT,NTLYERA,NTLYERO
...
! total optical depth=aerosol+rayleigh+gas absorption
  ...
  PHMXDATASTREAM(ITLYERA,1:NUMMIEANGMAX,0)=PHMXMIE_ARSL_PACE(1,IWV_BAND,1:NUMMIEANGMAX,0)
  ...
  ELSE
    PHMXDATASTREAM(ITLYERA,1:NUMMIEANGMAX,1:6)=PHMXMIE_ARSL_PACE(ARSL_TYPE(ITLYERA),IWV_BAND,1:NUMMIEANGMAX,1:6)
...
!RECDATASTREAM(NTLYERA+4+ITLYERW,2)
  ...
  IF(OCEAN_CASE_SELECT==0)THEN
     ...
     PHMXDATASTREAM(NTLYERA+1,1:NUMMIEANGMAX,0)=PHMXMIE_ARSL_PACE(1,IWV_BAND,1:NUMMIEANGMAX,0)
  ...
  ELSEIF(OCEAN_CASE_SELECT==1 .or. OCEAN_CASE_SELECT==3)THEN
     ...
     PHMXDATASTREAM(NTLYERA+ITLYERW,1:NUMMIEANGMAX,0)=PHMXMIE_ARSL_PACE(1,IWV_BAND,1:NUMMIEANGMAX,0)
