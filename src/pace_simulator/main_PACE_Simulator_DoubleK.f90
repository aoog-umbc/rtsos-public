...
WRITE(*,*)'SPHERICAL_SHELL_SINGLESCATTERING_CORRECTION IS', SPHERICAL_SHELL_SINGLESCATTERING_CORRECTION
...
!		   YK(1),YK(NILS_AVG/2),YK(NILS_AVG)
  ...
  ENDIF
  WRITE(*,*)'WV_BAND_HYPO,WV_SUB_START,WV_SUB_END=', &
...
! TESTING RESCALE ALGORITHM AND SEE IF TAU_REF IS CORRECTLY CALCULATED
    ...
    write(*,*)'IMIE,WV_BAND,TAU_REF is:',IMIE,WV_BAND(IWV_BAND),TAU_REF(IMIE),TAU_TEMP
ENDDO
