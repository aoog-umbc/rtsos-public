...
CALL STOKESOUT(OUTFILE,IAEROSOL,MU_IN,NTHETAOUT,NPHIOUT,PHIOUT,MUOUT,NWV_BAND_CAL,     &
        ...
        TEMPERTURE,SALINITY,AeroFMF,RH_simu)
...
REAL*8,INTENT(IN) :: TEMPERTURE,SALINITY,AeroFMF,RH_simu
...
IF(OCEAN_CASE_SELECT==1)THEN
  IF(BIOCASE1_SELECT==1) THEN
        ...
        BBPTCLOCAL=BPTC550*(0.002d0+0.01d0*(0.50d0-0.25d0*log10(CHLaVal))*(WAVELENGTH_MICRON/0.55)**BPTC_exp_coeff)
