...
REAL*8,DIMENSION(:,:,:),ALLOCATABLE::PHMXMIE_ARSL_PACE,PHMXMIE_Plankton_PACE,PHMXMIE_Mineral_PACE


CONTAINS

SUBROUTINE PHMXMIE_PACE_ALLO
...
ALLOCATE(PHMXMIE_ARSL_PACE(NWV_BAND,NUMMIEANGMAX,0:6), &
...
SUBROUTINE PHMXMIE_PACE_INIT(FREEFORMFLAG,IAEROSOL,AeroFMF,RH_Simu,NWV_PHMX,REFF1,VEFF1,REFF2,VEFF2,&
...
INTEGER,INTENT(IN) :: IAEROSOL,NWV_PHMX
...
IF(FREEFORMFLAG<=1)THEN
  ...
  PHMXMIE_ARSL_PACE(IWV_BAND,:,:)=(ARSLND1*CSCAT1*PHMXMIE_LOCAL1(:,:) + &
