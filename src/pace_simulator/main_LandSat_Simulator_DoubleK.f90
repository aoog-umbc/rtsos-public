...
REAL*8, ALLOCATABLE,DIMENSION(:) :: TAUR,TAU_TG,PNDLY,ARSLND1_Save,ARSLND2_Save,&
...
ALLOCATE(TAUR(NTLYERA), TAU_TG(NTLYERA))
...
!  write(*,*)'INDEX_TAUPRIME INFO',INDEX_TAUPRIME,NTLYERA
  DO IWV_SUB=IWV_SUB_START,IWV_SUB_END
    CALL TAU_TG_INIT(GAS_ABS_FLAG,NTLYERA,WV(IWV_SUB),TAU_TG)
...
USE GLOBAL_DATA, ONLY : ATMOS_ZERO,NPGRID,Z_FIELD,NUMDEN_TOTAL_FIELD,ALT_LYRA
...
USE GLOBAL_DATA, ONLY :NWV,WV,NPGRID,Z_FIELD,GAS_ABS_COEFF,ALT_LYRA
...
REAL*8,DIMENSION(NPGRID) ::TAU_ABS_GRID,TAU_ABS_CUMSUM
