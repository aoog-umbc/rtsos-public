MODULE PACE_INSTRUMENT_DESIGN
  ...
  !modify pace simulator for spex, harp and rsp
  !seg1 for SPEX (109)
  !seg2 for harp (4)
  !seg3 for RSP(9)
  
  INTEGER,PARAMETER :: NWV_BAND=122,NWV_BAND_SEG2=4,NWV_BAND_SEG3=9
...
CONTAINS
  ...
  SUBROUTINE WV_PACE_SETUP
    ...
    IF(NWV_BAND_SEG2 /= 4)STOP 'CHECK NWV AND NWV_SEG2'

    !pace oci with regular spectral resolution
    !    DO IWV=1,NWV_BAND-NWV_BAND_SEG2-NWV_BAND_SEG3
    !       WV_BAND(IWV)=WV_START+(IWV-1.0D0)*WV_BAND_WIDTH
    !    ENDDO

    !SPEX airborne, spectral difference is not regular
    !    WV_BAND_WIDTH(1:109)=2.0d0
    WV_BAND_WIDTH(1:109)=10.0d0 !test spex L1C
    WV_BAND(1:109)=(/ &
    ...
    ! replace original pace swir bands with airharp bands
    
    WV_BAND(NWV_BAND-NWV_BAND_SEG2-NWV_BAND_SEG3+1)=441.4d0
    WV_BAND(NWV_BAND-NWV_BAND_SEG2-NWV_BAND_SEG3+2)=549.8d0
    WV_BAND(NWV_BAND-NWV_BAND_SEG2-NWV_BAND_SEG3+3)=669.4d0
    WV_BAND(NWV_BAND-NWV_BAND_SEG2-NWV_BAND_SEG3+4)=867.8d0
    WV_BAND_WIDTH(NWV_BAND-NWV_BAND_SEG2-NWV_BAND_SEG3+1:NWV_BAND-NWV_BAND_SEG3)=&
         (/15.7d0, 12.4d0, 18.1d0, 38.7d0/)
