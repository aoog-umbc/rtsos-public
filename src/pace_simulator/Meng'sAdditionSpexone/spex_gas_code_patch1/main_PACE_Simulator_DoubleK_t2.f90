...
Print *, "Scale H2O, CO2, CH4, O2, O3, NO2, O4  vmr by:",Gas_Scale

CLOSE(1)

write(*,*)'Winds peed=',WNDSPD
...
SEG1ONLY=.FALSE.
ILS_FLAG=.true.
!ILS_FLAG=.false. !no integration, output all wavelength
...
IF(GAS_ABS_FLAG) THEN
  ...
  !Print *, "Scale H2O, CO2, CH4, O2, O3, NO2, O4  vmr by:",Gas_Scale
  VMR_H2O_FIELD(:)=VMR_H2O_FIELD(:)*Gas_Scale(1)
  VMR_CO2_FIELD(:)=VMR_CO2_FIELD(:)*Gas_Scale(2)
  VMR_CH4_FIELD(:)=VMR_CH4_FIELD(:)*Gas_Scale(3)
  VMR_OXYGEN_FIELD(:)=VMR_OXYGEN_FIELD(:)*Gas_Scale(4)
  VMR_OZONE_FIELD(:)=VMR_OZONE_FIELD(:)*Gas_Scale(5)
  VMR_NO2_FIELD(:)=VMR_NO2_FIELD(:)*Gas_Scale(6)
  CALL ABS_COEFF_INIT
ENDIF
...
DO IWV_BAND=1,NWV_BAND_END
  ...
  LOCINDXTMP= MINLOC(ABS(WV_BAND(IWV_BAND)-0.5D0*WV_BAND_WIDTH(IWV_BAND)-WV))
  LOCINDXTMP1=MINLOC(ABS(WV_BAND(IWV_BAND)+0.5D0*WV_BAND_WIDTH(IWV_BAND)-WV))
...
!  CALL ILS_INIT
  ...
  DO IWV_AVG=NWV_START,NWV_END
     ...
     WAVELENGTH_BAND_LO=WV_BAND(IWV_AVG)-2.0D0*WV_BAND_WIDTH(IWV_AVG)
     WAVELENGTH_BAND_HI=WV_BAND(IWV_AVG)+2.0D0*WV_BAND_WIDTH(IWV_AVG)
...
dimscl=(/ NWV_BAND /)
CALL h5screate_simple_f(1, dimscl, space, hdferr)
CALL h5dcreate_f(file, 'WaveLength_width_PACE', H5T_IEEE_F32LE, space, dset, hdferr)
ALLOCATE(HDF5RARR(NWV_BAND))
HDF5RARR=WV_BAND_WIDTH
CALL h5dwrite_f(dset, H5T_NATIVE_REAL,C_LOC(HDF5RARR(1)), hdferr)
DEALLOCATE(HDF5RARR)
CALL h5dclose_f(dset , hdferr)
CALL h5sclose_f(space, hdferr)
...
! OCEAN INTERFACE 
    ...
    RECDATASTREAM(NTLYERA+3,2)=WNDSPD
...
USE GLOBAL_DATA, ONLY :NWV,WV,NPGRID,P_GRID,Z_FIELD,TEM_FIELD,             &
                NUMDEN_TOTAL_FIELD,VMR_OZONE_FIELD,VMR_OXYGEN_FIELD,&
                VMR_H2O_FIELD,VMR_CO2_FIELD,VMR_NO2_FIELD,       &
                VMR_CH4_FIELD,GAS_ABS_COEFF, Gas_Scale
USE H2O_ABS_DATA
USE CO2_ABS_DATA
USE CH4_ABS_DATA
