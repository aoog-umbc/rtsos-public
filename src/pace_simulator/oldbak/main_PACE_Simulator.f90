...
MODULE GLOBAL_DATA
LOGICAL :: SEG1A2ONLY,SEG3ONLY,DIFFUSE_TRANSMITTANCE
INTEGER :: NDET
INTEGER,PARAMETER :: NOPT=7,NWNDSPD=3,NCHLa=8,NWV=128,NWV_SEG2=6,NWV_SEG3=12
...
GAS_ABS_FLAG=.true.
IF(SEG1A2ONLY .AND. SEG3ONLY) STOP 'SEG1A2ONLY .AND. SEG3ONLY CANNOT BOTH BE TRUE'
...
INTEGER :: NWV_START,NWV_END,NWV_OUTPUT
...
write(*,*)'testing bstc',BSTC665LOCAL,CSCAT2,AREA,REFFO2,WAVELENGTH_MICRON,SEDIMENT_SPECTRAL_SLOPE,ASTCLOCAL
      IF(BSTCLOCAL<0.0D0)STOP 'CHECK BSTCLOCAL'
      NDISTR=7
      MRLOCAL=SEDIMENT_INDEX_REFRACTION
      MILOCAL=0.0D0
      GAMMAI=SEDIMENT_SPECTRAL_SLOPE
...
WV(NWV-NWV_SEG3+1:NWV)=&
  (/0.34d0, 0.354d0, 0.388d0, 0.4160d0, 0.4420d0, 0.4515d0, 0.47d0,  &
    0.51d0, 0.551d0, 0.67d0, 0.765d0, 0.865d0/)
