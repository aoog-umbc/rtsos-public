PROGRAM SOSMAIN
USE RTUTILITY, ONLY : PI,FACTOR,NUMMIEANGMAX,PSEUDO_SPHERICAL_SHELL,I_SURFACE_ROUGHNESS_PARA
IMPLICIT NONE
...
LOGICAL :: WLR_FLAG_INPUT,WCFLG_INPUT,OCEAN_INPUT
...
LOOP_READ_CONFIG : DO WHILE (IREAD>-2000)
  ...
  IF(IREAD==-101) EXIT LOOP_READ_CONFIG
