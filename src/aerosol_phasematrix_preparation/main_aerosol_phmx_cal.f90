...
CALL Particle_PHMX_Assign_StandAlone(NUMMIEUSE,NWV_BAND,IAEROSOL,IRH, rf1, rf2, rf3, FRACS, FMFRAC, IREFF, IVAR,R0F,R0C,RHI, &
          R0DL,R0WS,R0BC,R0S,R0SS,MIX_FLAG,sigf,sigc,NMODE,DFRAC,DSFRAC,REFF1_Save,    &
          REFF2_Save,REFFDS,VEFF1_Save,VEFF2_Save,VEFFDS,MRR1_Save,MRI1_Save,MRR2_Save,&
...
CALL  PHMX_OUTPUT(OUTFILE,NMODE, &
     ...
     CEXT_ARSL_BAND, CSCAT_ARSL_BAND, PHMXMIE_ARSL_PACE, inputs21, iaerosol)
...
SUBROUTINE  PHMX_OUTPUT(CFILE1, NMODE,&
     ARSLND1_Save,ARSLND2_Save,ARSLNDDS,NUMMIEUSE,  &
     REFF1_Save,REFF2_Save,REFFDS,VEFF1_Save,VEFF2_Save,VEFFDS,&
     MRR1_Save,MRR2_Save,MRI1_Save,MRI2_Save,MRRD_save,MRID_save, &
     CEXT_ARSL_BAND, CSCAT_ARSL_BAND, PHMXMIE_ARSL_PACE,&
     inputs, iaerosol)
...
REAL*8 :: rtmp
INTEGER :: NUMMIEUSE,IMIE,NMODE
Integer :: NWVOS, IAEROSOL
REAL*8,DIMENSION(NUMMIEUSE) ::REFF1_Save,REFF2_Save,VEFF1_Save,VEFF2_Save,&
     ARSLND1_Save,ARSLND2_Save,ARSLNDDS,REFFDS,VEFFDS
REAL*8 ::REFFD,VEFFD,ARSLNDD
REAL*8,DIMENSION(NUMMIEUSE,NWV_BAND) ::MRR1_Save,MRR2_Save,MRI1_Save,MRI2_Save,MRRD_save,MRID_save
...
HDF5RARR=PHMXMIE_ARSL_PACE(1,1:NUM_SCAT_ANG,0)
CALL h5screate_simple_f(1, dimscl, space, hdferr)
...
!OCI
!write(*,*) PHMXMIE_ARSL_PACE(1,1:25,0)
...
HDF5RARR3DIM=PHMXMIE_ARSL_PACE(1:(NWV_BAND_SEG1+NWV_BAND_SEG2),1:NUM_SCAT_ANG,1:6)
...
!write(*,*) 'PHMX',PHMXMIE_ARSL_PACE(1:5,1:10,1)
...
!write(*,*)'PHMXMIE_ARSL_PACE_at output writing',PHMXMIE_ARSL_PACE((NWVOS+1):(NWVOS+6),1,1)
!write(*,*) 'PHMXMIE_ARSL_PACE',PHMXMIE_ARSL_PACE(:5,1,1)

dims3 = (/NWV_BAND_SEG3,NUM_SCAT_ANG,6/)
ALLOCATE(HDF5RARR3DIM(NWV_BAND_SEG3,NUM_SCAT_ANG,6))
HDF5RARR3DIM=PHMXMIE_ARSL_PACE((NWVOS+1):(NWVOS+NWV_BAND_SEG3),1:NUM_SCAT_ANG,1:6)
CALL h5screate_simple_f(3, dims3, space, hdferr)
...
HDF5RARR3DIM=PHMXMIE_ARSL_PACE((NWVOS+1):(NWVOS+NWV_BAND_SEG4),1:NUM_SCAT_ANG,1:6)
CALL h5screate_simple_f(3, dims3, space, hdferr)
...
SUBROUTINE Particle_PHMX_Assign_StandAlone(NUMMIEUSE,NWV_PHMX,IAEROSOL,IRH,rf1, rf2, rf3,FRACS, FMFRAC, IREFF, IVAR,R0F,R0C,RHI, &
      R0DL,R0WS,R0BC,R0S,R0SS,MIX_FLAG,sigf,sigc,nmode,dfrac,dsfrac,REFF1_Save,&
     REFF2_Save,REFFDS,VEFF1_Save,VEFF2_Save,VEFFDS,MRR1_Save,MRI1_Save,MRR2_Save,&
                 MRI2_Save,MRRD_save,MRID_save,ARSLND1_Save,ARSLND2_Save,ARSLNDDS)
USE MIE_PHMX_CAL
...
INTEGER, INTENT(IN)::NUMMIEUSE,NWV_PHMX,IAEROSOL,IRH, IREFF, IVAR, MIX_FLAG,NMODE
...
CALL PHMXMIE_Instrument_INIT(FREEFORMFLAG,IAEROSOL,IRH, rf1, rf2,rf3, FRACS,FMFRAC, IREFF, IVAR,R0F,R0C,RHI,&
