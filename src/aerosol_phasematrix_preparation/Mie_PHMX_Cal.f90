...
!REAL*8,DIMENSION(NWV_BAND,NUMMIEANGMAX,0:6)::PHMXMIE_ARSL
...
SUBROUTINE PHMXMIE_ALLO
ALLOCATE(CEXT_ARSL_BAND(NWV_BAND),CSCAT_ARSL_BAND(NWV_BAND), &
		 PHMXMIE_ARSL(NWV_BAND,NUMMIEANGMAX,0:6))
END SUBROUTINE PHMXMIE_ALLO

SUBROUTINE PHMXMIE_DEALLO
DEALLOCATE(CEXT_ARSL_BAND,CSCAT_ARSL_BAND,PHMXMIE_ARSL)
END SUBROUTINE PHMXMIE_DEALLO


SUBROUTINE PHMXMIE_Instrument_INIT(aux_dir,FREEFORMFLAG,NWV_BAND_START,NWV_BAND_END, &
       ...
       REFF1,VEFF1,REFF2,VEFF2,REFFD,VEFFD,MRR1,MRI1,MRR2,MRI2,MRRD,&
       MRID,ARSLND1,ARSLND2,ARSLNDD)
USE DUST_DATA
IMPLICIT NONE
CHARACTER(LEN=360),intent(in) :: aux_dir
INTEGER,INTENT(IN) :: FREEFORMFLAG
INTEGER,INTENT(IN) :: NWV_BAND_START,NWV_BAND_END,IAEROSOL,IRH, IREFF, IVAR, MIX_FLAG,NMODE
REAL*8, INTENT(IN) :: rf1,rf2,rf3,FRACS,FMFRAC,R0F,R0C,R0DL,R0WS,R0BC,R0S,R0SS,sigf,sigc,DFRAC,DSFRAC
REAL*8,INTENT(INOUT)::REFF1,VEFF1,REFF2,VEFF2,ARSLND1,ARSLND2,ARSLNDD,REFFD,VEFFD,RHI
...
IF(FREEFORMFLAG==1 .AND. (IAEROSOL==-98 .or. IAEROSOL==-96))THEN
	REFF1_LOCAL=REFF1
	VEFF1_LOCAL=VEFF1
	REFF2_LOCAL=REFF2
	VEFF2_LOCAL=VEFF2
    IF(IAEROSOL==-98)THEN
        NDISTR=4
		DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
		   MRR1(IWV_BAND)=Func_UVIP3P(NWV_SF,WV_SF,MR_WATER_SF,WV_BAND_MICRON(IWV_BAND),3)
		   MRI1(IWV_BAND)=Func_UVIP3P(NWV_SF,WV_SF,MI_WATER_SF,WV_BAND_MICRON(IWV_BAND),3)
		   MRR2(IWV_BAND)=MRR1(IWV_BAND)
		   MRI2(IWV_BAND)=MRI1(IWV_BAND)
		ENDDO
    ELSE
       NDISTR=2
    ENDIF
	...
	DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
		...
		CEXT_ARSL_BAND(IWV_BAND)=CEXT1
		CSCAT_ARSL_BAND(IWV_BAND)=CSCAT1
		PHMXMIE_ARSL(IWV_BAND,:,:)= PHMXMIE_LOCAL1(:,:)
    ENDDO
	write(*,*) '**********************************************'
	WRITE(*,*) 'MONO MODAL SIZE DISTRIBUTION PHASE MATRIX CALCULATION'
	write(*,*) '**********************************************'
	write(*,*) 'Reff=',REFF1_LOCAL
	write(*,*) 'Veff=', VEFF1_LOCAL
	write(*,*) 'MR=',MRR1(1)
	write(*,*) 'MI=',MRI1(1)
...
IF(FREEFORMFLAG==1 .AND. IAEROSOL>0 .AND. IAEROSOL<21)THEN
  ...
  IF(IAEROSOL==1)THEN !rural 
       MRR1(NWV_BAND_START:NWV_BAND_END)=MR_TRPOSPHERE(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI1(NWV_BAND_START:NWV_BAND_END)=MI_TRPOSPHERE(NWV_BAND_START:NWV_BAND_END,IRH)
       MRR2(NWV_BAND_START:NWV_BAND_END)=MR_RURALC(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI2(NWV_BAND_START:NWV_BAND_END)=MI_RURALC(NWV_BAND_START:NWV_BAND_END,IRH)
  ELSEIF(IAEROSOL==2)THEN ! URBAN
       MRR1(NWV_BAND_START:NWV_BAND_END)=MR_URBANF(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI1(NWV_BAND_START:NWV_BAND_END)=MI_URBANF(NWV_BAND_START:NWV_BAND_END,IRH)
       MRR2(NWV_BAND_START:NWV_BAND_END)=MR_URBANC(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI2(NWV_BAND_START:NWV_BAND_END)=MI_URBANC(NWV_BAND_START:NWV_BAND_END,IRH)
  ELSEIF(IAEROSOL==3)THEN ! URBAN A
       MRR1(NWV_BAND_START:NWV_BAND_END)=MR_URBANAF(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI1(NWV_BAND_START:NWV_BAND_END)=MI_URBANAF(NWV_BAND_START:NWV_BAND_END,IRH)
       MRR2(NWV_BAND_START:NWV_BAND_END)=MR_URBANAC(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI2(NWV_BAND_START:NWV_BAND_END)=MI_URBANAC(NWV_BAND_START:NWV_BAND_END,IRH)
  ELSEIF(IAEROSOL==4)THEN  ! URBAN A1
       MRR1(NWV_BAND_START:NWV_BAND_END)=MR_URBANA1F(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI1(NWV_BAND_START:NWV_BAND_END)=MI_URBANA1F(NWV_BAND_START:NWV_BAND_END,IRH)
       MRR2(NWV_BAND_START:NWV_BAND_END)=MR_URBANA1C(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI2(NWV_BAND_START:NWV_BAND_END)=MI_URBANA1C(NWV_BAND_START:NWV_BAND_END,IRH)
    ELSEIF(IAEROSOL==5)THEN! URBAN A2
       MRR1(NWV_BAND_START:NWV_BAND_END)=MR_URBANA2F(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI1(NWV_BAND_START:NWV_BAND_END)=MI_URBANA2F(NWV_BAND_START:NWV_BAND_END,IRH)
       MRR2(NWV_BAND_START:NWV_BAND_END)=MR_URBANA2C(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI2(NWV_BAND_START:NWV_BAND_END)=MI_URBANA2C(NWV_BAND_START:NWV_BAND_END,IRH)
    ELSEIF(IAEROSOL==6)THEN! URBAN A3
       MRR1(NWV_BAND_START:NWV_BAND_END)=MR_URBANA3F(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI1(NWV_BAND_START:NWV_BAND_END)=MI_URBANA3F(NWV_BAND_START:NWV_BAND_END,IRH)
       MRR2(NWV_BAND_START:NWV_BAND_END)=MR_URBANA3C(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI2(NWV_BAND_START:NWV_BAND_END)=MI_URBANA3C(NWV_BAND_START:NWV_BAND_END,IRH)
    ELSEIF(IAEROSOL>=7 .AND. IAEROSOL<=9 .AND. IAEROSOL>0)THEN! MARINETIME
       MRR1(NWV_BAND_START:NWV_BAND_END)=MR_TRPOSPHERE(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI1(NWV_BAND_START:NWV_BAND_END)=MI_TRPOSPHERE(NWV_BAND_START:NWV_BAND_END,IRH)
       MRR2(NWV_BAND_START:NWV_BAND_END)=MR_OCEANIC(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI2(NWV_BAND_START:NWV_BAND_END)=MI_OCEANIC(NWV_BAND_START:NWV_BAND_END,IRH)
    ELSEIF(IAEROSOL==10)THEN
       MRR1(NWV_BAND_START:NWV_BAND_END)=MR_TRPOSPHERE(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI1(NWV_BAND_START:NWV_BAND_END)=MI_TRPOSPHERE(NWV_BAND_START:NWV_BAND_END,IRH)
       MRR2(NWV_BAND_START:NWV_BAND_END)=1.0
       MRI2(NWV_BAND_START:NWV_BAND_END)=0.0
    ELSEIF((IAEROSOL>10).AND.(IAEROSOL<21) .AND. IAEROSOL>0)THEN
       MRR1(NWV_BAND_START:NWV_BAND_END)=MR_ZIAF(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI1(NWV_BAND_START:NWV_BAND_END)=MI_ZIAF(NWV_BAND_START:NWV_BAND_END,IRH)
       MRR2(NWV_BAND_START:NWV_BAND_END)=MR_ZIAC(NWV_BAND_START:NWV_BAND_END,IRH)
       MRI2(NWV_BAND_START:NWV_BAND_END)=MI_ZIAC(NWV_BAND_START:NWV_BAND_END,IRH)
    ENDIF
...
! pass effective radius and variance back to main program for output
 ...
 DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
    ...
    ENDIF
          ...
          IF(FREEFORMFLAG<=1)THEN
             ...
             PHMXMIE_ARSL(IWV_BAND,:,:)= &
                 (ARSLND1*CSCAT1*PHMXMIE_LOCAL1(:,:)  &
 ...
 IF(FREEFORMFLAG>=0 .AND. IAEROSOL==-99 .AND. MIX_FLAG==0) THEN !INTERNAL MIXING OF FINE MODE AEROSOLS
    ...
    MRR1(NWV_BAND_START:NWV_BAND_END)=MR_FLEXF(NWV_BAND_START:NWV_BAND_END)
    MRI1(NWV_BAND_START:NWV_BAND_END)=MI_FLEXF(NWV_BAND_START:NWV_BAND_END)
    MRR2(NWV_BAND_START:NWV_BAND_END)=MR_FLEXC(NWV_BAND_START:NWV_BAND_END)
    MRI2(NWV_BAND_START:NWV_BAND_END)=MI_FLEXC(NWV_BAND_START:NWV_BAND_END)
...
CALL DUST_SCAT_PROP_INIT(aux_dir,IREFF,IVAR,PHMX_DUST_TMP,CEXT_DUST_TMP,CSCAT_DUST_TMP,SCATANG)

DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
    WV_tmp=WV_BAND_MICRON(IWV_BAND)
    
    CEXT_DUST(IWV_BAND)=Func_UVIP3P(NWV_D,WVL,CEXT_DUST_TMP,WV_tmp,3)
    CSCAT_DUST(IWV_BAND)=Func_UVIP3P(NWV_D,WVL,CSCAT_DUST_TMP,WV_tmp,3)
    MRR_DUST(IWV_BAND)=Func_UVIP3P(NWV_D,WVL,MRD,WV_tmp,3)
    MRI_DUST(IWV_BAND)=Func_UVIP3P(NWV_D,WVL,MID,WV_tmp,3)
    DO IANG=1,NSCATANG
       DO IPHMX=1,6
          PHMX_DUST_TMP2(IWV_BAND,IANG,IPHMX)=Func_UVIP3P(NWV_D,WVL,PHMX_DUST_TMP(:,IANG,IPHMX),WV_tmp,3)
       END DO
    END DO
 END DO
   ...
   IF(NMODE==2)THEN
    ...
    DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
      DO IANG=1,NUM_SCAT_ANG
         DO IPHMX=1,6
            PHMX_DUST(IWV_BAND,IANG,IPHMX)=Func_UVIP3P(NSCATANG,SCATANG,PHMX_DUST_TMP2(IWV_BAND,:,IPHMX),&
...
ENDIF
   ...
   IF (FMFRAC==1.0) THEN
	   MRR2=0.0D0
	   MRI2=0.D0
   ELSEIF (FMFRAC==0.0D0) THEN !for fmfrac=0, soot=(1-(r1+r2+r3))=1
	   MRR1=0.0D0
	   MRI1=0.0D0
   ENDIF
...
CSCAT_ARSL_BAND=ARSLND1*CSCAT1_MIE+ARSLND2*CSCATC
    ...
    DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
       IF (FMFRAC==0.0D0) THEN
       PHMXMIE_ARSL(IWV_BAND,:,0)=PHMXMIE_LOCAL2_MIE(IWV_BAND,:,0)
    ELSEIF (FMFRAC>0.0D0) THEN
       PHMXMIE_ARSL(IWV_BAND,:,0)=PHMXMIE_LOCAL1_MIE(IWV_BAND,:,0)
    ENDIF

	PHMXMIE_ARSL(IWV_BAND,:,1:6)= ( &
    ...
    IF(NMODE==3)THEN
       ...
       MRRDS(NWV_BAND_START:NWV_BAND_END) = MR_DUSTF_TMP1(NWV_BAND_START:NWV_BAND_END)
       MRIDS(NWV_BAND_START:NWV_BAND_END) = MI_DUSTF_TMP1(NWV_BAND_START:NWV_BAND_END)
       ...
       VEFFD_LOCAL = EXP(VDLN)-1.0D0
        ...
        WRITE(*,*)'MRIDS',MRIDS(:5)
       DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
          IF(DSFRAC>0.0D0 .OR. DFRAC>0.0D0) THEN !DUST MODE SPHERICAL DUST
...
IF(NMODE==3)THEN
    IF((1-DSFRAC)>0.0D0)THEN
     DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
       DO IANG=1,NUM_SCAT_ANG
          DO IPHMX=1,6
             PHMX_DUST(IWV_BAND,IANG,IPHMX)=Func_UVIP3P(NSCATANG,SCATANG,PHMX_DUST_TMP2(IWV_BAND,:,IPHMX),&
    PHMXMIE_LOCALD_MIE(IWV_BAND,IANG,0),3)
          END DO
       END DO
    END DO
    ELSE
...
WRITE(*,*)'MRI_DUST',MRI_DUST(:5)
    ...
    ENDIF
        ...
        IF (1-(FMFRAC+DFRAC)==0)THEN
        REFF2=0
        VEFF2=0
        ARSLND2=0
        CEXT2_MIE=0
        CSCAT2_MIE=0
        PHMXMIE_LOCAL2_MIE(:,:,:)=0
        ENDIF
        ...
        WRITE(*,*)'dust mode number density',ARSLNDD
          ...
          DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
            IF((1-(FMFRAC+DFRAC))>0.0D0) THEN
             ...
             ELSEIF (FMFRAC>0.0D0) THEN
                PHMXMIE_ARSL(IWV_BAND,:,0)=PHMXMIE_LOCAL1_MIE(IWV_BAND,:,0)
            ELSEIF(DSFRAC>0 .OR. DFRAC>0)THEN
                PHMXMIE_ARSL(IWV_BAND,:,0)=PHMXMIE_LOCALD_MIE(IWV_BAND,:,0)
             ENDIF
...
ENDIF
 ...
 IF(FREEFORMFLAG>0 .AND. IAEROSOL==-99 .AND. MIX_FLAG==2) THEN
    ...
    ARSLND1_S = 0
    ENDIF
    IF (DFRAC==0 .OR. DSFRAC==0)THEN
    ARSLND1_DL=0
    ENDIF
    ENDIF

 
    MRR1_DL(NWV_BAND_START:NWV_BAND_END) = MR_DUSTF_TMP1(NWV_BAND_START:NWV_BAND_END)
    MRR1_WS(NWV_BAND_START:NWV_BAND_END) = MR_WATER_SOLUBLE_TMP1(NWV_BAND_START:NWV_BAND_END)
    MRR1_BC(NWV_BAND_START:NWV_BAND_END) = MR_BRC_TMP1(NWV_BAND_START:NWV_BAND_END)
    MRR1_S(NWV_BAND_START:NWV_BAND_END) = MR_SOOTF_TMP1(NWV_BAND_START:NWV_BAND_END)
    MRR2_SS(NWV_BAND_START:NWV_BAND_END) = MR_ZIACR(NWV_BAND_START:NWV_BAND_END)

    MRI1_DL(NWV_BAND_START:NWV_BAND_END) = MI_DUSTF_TMP1(NWV_BAND_START:NWV_BAND_END)
    MRI1_WS(NWV_BAND_START:NWV_BAND_END) = MI_WATER_SOLUBLE_TMP1(NWV_BAND_START:NWV_BAND_END)
    MRI1_BC(NWV_BAND_START:NWV_BAND_END) = MI_BRC_TMP1(NWV_BAND_START:NWV_BAND_END)
    MRI1_S(NWV_BAND_START:NWV_BAND_END) = MI_SOOTF_TMP1(NWV_BAND_START:NWV_BAND_END)
    MRI2_SS(NWV_BAND_START:NWV_BAND_END) = MI_ZIACR(NWV_BAND_START:NWV_BAND_END)
    ...
    DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
       ...
       DO IANG=1,NSCATANG
          DO IPHMX=1,6
             PHMX_DUST_TMP2(IWV_BAND,IANG,IPHMX)=Func_UVIP3P(NWV_D,WVL,&
...
ELSEIF (FMFRAC==1.0D0)THEN !NO COARSE MODE PRESENT
    ARSLND2_SS = 0.0D0
    ARSLND2_D = 0.0D0
ENDIF
ENDIF
...
IF(NMODE==3)THEN
    IF(FMFRAC<1.0D0)THEN
        ARSLND2_SS=1.0D0-(FMFRAC+DFRAC)
        IF(DFRAC>0.0D0)THEN
            ARSLND2_D=DFRAC*(1.0D0-DSFRAC) !!IS THIS CORRECT? THIS IS NOT THE EXACT NUMBER DENSITY
            ELSE
            ARSLND2_D=0.0D0
        ENDIF
    ELSEIF (FMFRAC==1.0D0)THEN !NO COARSE MODE OR DUST MODE PRESENT
        ARSLND2_SS = 0.0D0
        ARSLND2_D = 0.0D0
    ENDIF
...
ENDIF
    ...
    !MIE SCATTERING CALCULATION
     DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
		...
		IF (ARSLND2_SS>0 .OR. ARSLND2_D>0)THEN
...
IF (ARSLND2_SS>0.0D0 .OR. ARSLND2_D>0.0D0) THEN
     DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
        DO IANG=1,NUM_SCAT_ANG
           DO IPHMX=1,6
              PHMX_DUST(IWV_BAND,IANG,IPHMX)=Func_UVIP3P(NSCATANG,SCATANG,PHMX_DUST_TMP2(IWV_BAND,:,IPHMX),&
...
IF (FMFRAC>0.0D0 .OR. (1-FMFRAC)>0.0D0)THEN
     RTMP=RTMP1+RTMP2
...
ENDIF
    ...
    CSCAT_ARSL_BAND=ARSLND1*CSCATF+ARSLND2*CSCATC
     ...
     DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
        IF (ARSLND1_DL>0)THEN
        PHMXMIE_ARSL(IWV_BAND,:,0)=PHMXMIE_LOCAL1A_DL(IWV_BAND,:,0)
        ELSEIF (ARSLND1_WS>0)THEN
        PHMXMIE_ARSL(IWV_BAND,:,0)=PHMXMIE_LOCAL1A_WS(IWV_BAND,:,0)
        ELSEIF (ARSLND1_BC>0)THEN
        PHMXMIE_ARSL(IWV_BAND,:,0)=PHMXMIE_LOCAL1A_BC(IWV_BAND,:,0)
        ELSEIF (ARSLND1_S>0)THEN
        PHMXMIE_ARSL(IWV_BAND,:,0)=PHMXMIE_LOCAL1A_S(IWV_BAND,:,0)
        ELSEIF (ARSLND2_SS>0 )THEN
        PHMXMIE_ARSL(IWV_BAND,:,0)=PHMXMIE_LOCAL2A_SS(IWV_BAND,:,0)
        ELSEIF (ARSLND2_D>0 )THEN
        PHMXMIE_ARSL(IWV_BAND,:,0)=PHMXMIE_LOCAL2A_SS(IWV_BAND,:,0)
        ENDIF
...
!    ENDIF
    ...
    MRIDT = DSFRAC*MRI1_DL+(1-DSFRAC)*MRI_DUST
...
IF(DFRAC>0.0D0 .AND. DSFRAC>0.0D0)THEN !USED AS A REFERENCE, NOT THE EXACT
    ARSLND1_DL = DFRAC*DSFRAC
ELSE
    ARSLND1_DL =0.0D0
ENDIF
...
IF ((1-FMFRAC)>0.0D0 .AND. (1-FRACS)>0.0D0) THEN
    DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
        DO IANG=1,NUM_SCAT_ANG
            DO IPHMX=1,6
                PHMX_DUST(IWV_BAND,IANG,IPHMX)=Func_UVIP3P(NSCATANG,SCATANG,PHMX_DUST_TMP2(IWV_BAND,:,IPHMX),&
...
IF(FMFRAC>0.0D0)THEN
SIGMA_G1 = SQRT(LOG(VEFF1_LOCAL+1.0D0))
R_G1 = REFF1_LOCAL/EXP(2.50D0*SIGMA_G1*SIGMA_G1)
ELSE
SIGMA_G1=0.0D0
R_G1=0.0D0
ENDIF
...
SIGMA_G2 = SQRT(LOG(VEFF2_LOCAL+1.0D0))
R_G2 = REFF2_LOCAL/EXP(2.50D0*SIGMA_G2*SIGMA_G2)
M22 = R_G2*R_G2*EXP(2*SIGMA_G2*SIGMA_G2)
M32 = R_G2*R_G2*R_G2*EXP(4.50D0*SIGMA_G2*SIGMA_G2)

SIGMA_GD = SQRT(LOG(SIGMA(IVAR)))
R_GD = REFF(IREFF)/EXP(2.50D0*SIGMA_GD*SIGMA_GD)
M2D = R_GD*R_GD*EXP(2*SIGMA_GD*SIGMA_GD)
M3D = R_GD*R_GD*R_GD*EXP(4.50D0*SIGMA_GD*SIGMA_GD)
...
ENDIF
      ...
      DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
       ...
       PHMXMIE_ARSL(IWV_BAND,:,1:6)=(ARSLND1*CSCAT1_MIE(IWV_BAND)* &
...
IF ((1-FMFRAC)>0.0D0 .AND. (1-DSFRAC)>0.0D0) THEN
DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
    DO IANG=1,NUM_SCAT_ANG
       DO IPHMX=1,6
          PHMX_DUST(IWV_BAND,IANG,IPHMX)=Func_UVIP3P(NSCATANG,SCATANG,PHMX_DUST_TMP2(IWV_BAND,:,IPHMX),&
...
!      WRITE (*,1001) AREA,VOL,RVW,RMEAN,REFFO,VEFFO
! 1001 FORMAT ('<G> = ',D12.6,'  <V> = ',D12.6,'  Rvw = ',D12.6,&
!             &'  <R> = ',D12.6, '  Reffo = ',D12.6,'  Veffo = ',D12.6)
!write(*,*)'testing coefficients, WVNM=',WVNM
!  DO INTTMP=1,LMAXI+1
!      write(*,*)AL1(INTTMP),AL2(INTTMP),AL3(INTTMP),AL4(INTTMP),&
!             BET1(INTTMP),BET2(INTTMP)
!  ENDDO
!write(*,*)'testing phmx'
!	DO INTTMP=1,NANGMIE_LOCAL
!		write(*,'(7(2x,f12.6))')PHMXMIE_LOCAL(INTTMP,0:6)
!	ENDDO
!stop
      RETURN
