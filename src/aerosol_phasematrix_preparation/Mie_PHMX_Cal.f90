...
IF(FREEFORMFLAG==1 .AND. (IAEROSOL==-98 .or. IAEROSOL==-96))THEN
    ...
    IF(IAEROSOL==-98)THEN
        NDISTR=4
		DO IWV_BAND=NWV_BAND_START,NWV_BAND_END
		   MRR1(IWV_BAND)=POLINT_SIMPLE(NWV_SF,WV_SF,MR_WATER_SF,WV_BAND_MICRON(IWV_BAND),3)
		   MRI1(IWV_BAND)=POLINT_SIMPLE(NWV_SF,WV_SF,MI_WATER_SF,WV_BAND_MICRON(IWV_BAND),3)
